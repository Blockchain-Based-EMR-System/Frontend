...
import { useUpdateClinic } from "../../query/useClinics.query";
import { Clinic } from "../../types/clinic.types";
import { useLanguage } from "@/contexts/LanguageProvider";

interface EditClinicDialogPresentationalProps {
  open: boolean;
...
function EditClinicDialogPresentational({
  open,
  onOpenChange,
  onSubmit,
  isLoading,
  clinic,
}: EditClinicDialogPresentationalProps) {
          ...
          >
            ...
            <div className="flex gap-3 justify-end">
              ...
              <Button type="submit" disabled={isLoading}>
                {isLoading ? tCommon("submitting") : t("updateClinic")}
              </Button>
            </div>
          </form>
        </Form>
...
export function EditClinicDialog({
  ...
  return (
    <EditClinicDialogPresentational
      open={open}
